...
Bearing Processor - Interpolates points on an input line event based on time or distance. 

![Image of interpolate](interpolatepoints_390X150.png)
...
* Open a command prompt and navigate to `solutions-geoevent-java/solutions-geoevent/10.3.0/processors/incrementalPoint-processor`
    * Enter `mvn install` at the prompt.

## Installation

* Install the Bearing Processor.
    * Browse to `solutions-geoevent-java/solutions-geoevent/processors/10.3.0/incrementalPoint-processor/target` (this directory is created when you execute mvn install).
...
You will use the Bearing-Test service from the Solutions Test Configuration to test the functionality of the Interpolate Points processor.
