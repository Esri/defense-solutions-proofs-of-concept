...
public class UpdateOnlyProcessorDefinition extends GeoEventProcessorDefinitionBase
{
  ...
  public UpdateOnlyProcessorDefinition()
  {
    try
    {
      ...
      // The second parameter is the property type, and allows the server to validate property values provided by the
      // user (e.g. "hello" is not a valid integer value).
      ...
      // The seventh parameter specifies if the property is read-only, meaning it is shown to the user but cannot be
      // modified.
      ...
      // after creating the property definition, put it in the base class's "propertyDefinitions" structure. These
      // definitions will be provided to the
    ...
    {
      LOGGER.error("Failed to initialize Updates Only Processor definition: ", propertyException);
    }
  }
  ...
  {
    return "${com.esri.geoevent.processor.updateOnly-processor.LABEL}";
  }

  @Override
  public String getDescription()
  {
    return "${com.esri.geoevent.processor.updateOnly-processor.DESCRIPTION}";
  }
