 ...
 * 
 * 
 * @see Session#onEvent(com.esri.geoevent.solutions.transport.irc.jerklib.tasks.Task, com.esri.geoevent.solutions.transport.irc.jerklib.events.IRCEvent.Type...)
 * @see Type
 * @author mohadib
 *
 */
