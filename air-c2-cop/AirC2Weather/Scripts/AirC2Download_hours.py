...
#for N in (402,408,414,420,426,432,438,444,450):
for N in (402,408):

    now_time = time(int((datetime.utcnow()- timedelta(hours=N)).strftime("%H")), int((datetime.utcnow()- timedelta(hours=N)).strftime("%M")), int((datetime.utcnow()- timedelta(hours=N)).strftime("%S")))
